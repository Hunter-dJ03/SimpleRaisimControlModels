...
public:
	QuadrupedLegController() : Node("quadruped_controller")
	{
...

		{
			...
			pcom[0] = {0.0, 0.0, 0.086};
			pcom[1] = {0.0, 0.0, 0.086};
			pcom[2] = {0.0, 0.0, 0.086};
			pcom[3] = {0.0, 0.0, 0.086};
			pcom[4] = {0.0, 0.0, 0.086};
			pcom[5] = {0.0, 0.0, 0.086};
			pcom[6] = {0.0, 0.0, 0.086};
			pcom[7] = {0.0, 0.0, 0.086};
			pcom[8] = {0.0, 0.0, 0.086};
			pcom[9] = {0.0, 0.0, 0.086};
			pcom[10] = {0.0, 0.0, 0.086};
			pcom[11] = {0.0, 0.0, 0.086};
			pcom[12] = {0.0, 0.0, 0.086};
		}
